  ...
  return (
    <Box sx={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center',
      ...
      <Paper elevation={6} sx={{ p:4, width:420, borderRadius:3 }}>
        <Typography variant="h5" fontWeight="bold" textAlign="center" color="primary" mb={2}>Registro de Proveedor</Typography>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Button fullWidth type="submit" variant="contained" size="large" sx={{ mt:2 }} disabled={loading}>
            {loading ? <CircularProgress size={24} color="inherit" /> : 'Registrarme como Proveedor'}
          </Button>
        </form>
